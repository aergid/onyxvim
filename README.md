# Neovim flake based on nixCats-nvim

Cloned from kohane27/nixCats-nvim-example
...
1. Removed the fallback `paq-nvim` package manager when not on Nix. I will never _NOT_ be on Nix and I don't want to maintain a separate plugin list.
