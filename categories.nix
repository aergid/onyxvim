...
in { pkgs, settings, categories, name, extra, mkNvimPlugin, ... }@packageDef: {
  ...
  environmentVariables = { test = { ONYXVIM_TEST = "It worked!"; }; };
  sharedLibraries = { };
  extraWrapperArgs = { };
  ...
  startupPlugins = with pkgs.vimPlugins; {
    ...
    startup = with pkgs.vimPlugins; {
      colorscheme = [ catppuccin-nvim kanagawa-nvim ];
      general = [
        dressing-nvim
        mini-nvim
        nui-nvim
  ...
  optionalPlugins = with pkgs.vimPlugins; {
    ...
    ai = {
      avante = [ avante-nvim ];
      companion = [ pkgs.neovimPlugins.codecompanion ];
      minuet = [ minuet-ai-nvim ];
    };
    debug = [ nvim-dap nvim-dap-ui nvim-dap-virtual-text ];
